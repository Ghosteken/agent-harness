...
| API Development | ~30 | REST APIs, GraphQL, OpenAPI, webhooks |
| Mobile | 21 | React Native, Flutter, iOS |
| Game Dev | 15 | Unity, WebGL, 3D |
| Data Science | 14 | Pandas, NumPy, Analytics |
| Cloud Architecture | ~25 | Well-Architected, multi-region, DR, HA |
...
11. API Development (~30)
12. Cloud Architecture (~25)
...
**API Development**: api, rest, graphql, openapi, swagger, endpoint, versioning, rate-limit, webhook, idempotent, pagination, contract-first, oauth2, jwt

**Cloud Architecture**: well-architected, multi-region, multi-az, disaster-recovery, high-availability, rto, rpo, cost-optimisation, service-mesh, auto-scaling, reserved-capacity

**Backend** (extended): queue, message, async, caching, circuit-breaker, graceful, idempotent, contract, pagination, graphql, webhook

**AI/ML** (extended): rag, prompt-engineering, fine-tuning, guardrail, hallucination, evaluation, golden-set, prompt-injection, llm-judge, agent-orchestration
