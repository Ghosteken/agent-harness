...
- **`skills/`** contains only the 175 skills this scheme resolves to — everything else from the original bulk import lives in **`archive/skills-community/`**, unexposed to the agent but still browsable and restorable (`git mv` it back into `skills/` if you need it).
