...
This document describes the structure and format of agent-harness skill files. Use this as a guide when contributing new skills or understanding existing ones.
