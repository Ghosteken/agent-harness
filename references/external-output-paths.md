...
`briefings/README.md` follows the same pattern for `project-compass`: a maintained index linking the Overview, every per-repo breakdown (multi-repo projects), and every Suggested Direction doc, updated in place rather than replaced.
