...
CATEGORY_KEYWORDS = {
    ...
    "backend": [
        ...
        "rest", "graphql", "endpoint", "versioning", "rate-limit", "webhook",
        "idempotent", "contract", "pagination", "queue", "message", "async",
        "caching", "circuit-breaker", "graceful",
    ],
    "api-development": [
        "api", "rest", "graphql", "openapi", "swagger", "endpoint", "versioning",
        "rate-limit", "webhook", "idempotent", "pagination", "contract-first",
        "oauth2", "jwt", "http-method", "resource", "crud",
    ],
    "database": [
        "database", "sql", "postgres", "mysql", "mongodb", "redis", "dynamodb",
        "orm", "schema", "query",
        "migration", "indexing", "index", "query-optimization", "nosql",
        "transaction", "foreign-key", "normaliz", "backup", "connection-pool",
        "3nf", "bcnf",
    ],
    "ai-ml": [
        "llm", "gpt", "ai", "machine learning", "deep learning", "pytorch",
        "tensorflow", "embedding", "rag", "transformer", "model",
        "prompt-engineering", "fine-tuning", "guardrail", "hallucination",
        "evaluation", "golden-set", "token", "embedding-pipeline",
        "agent-orchestration", "llm-judge", "prompt-injection",
    ],
    "cloud-devops": [
        "docker", "kubernetes", "k8s", "ci/cd", "github actions", "terraform",
        "ansible", "aws", "azure", "gcp", "deployment", "devops", "serverless",
        "well-architected", "multi-region", "iac", "service-mesh",
        "cost-optimization", "iam", "ha", "disaster-recovery", "auto-scaling",
        "canary", "blue-green", "gitops", "slo", "sli", "runbook", "incident",
    ],
    "cloud-architecture": [
        "well-architected", "multi-region", "multi-az", "disaster-recovery",
        "high-availability", "rto", "rpo", "cost-optimisation", "cost-optimization",
        "service-mesh", "vendor-lock-in", "cloud-architect", "iaas", "paas",
        "auto-scaling", "reserved-capacity", "egress",
    ],
    "security": [
