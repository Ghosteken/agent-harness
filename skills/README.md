...
This folder holds agent-harness's curated skill set: **171 skills** — the 24 hand-authored lifecycle skills plus a role-scoped extension set defined in [`scripts/agent-scopes.json`](../scripts/agent-scopes.json).
