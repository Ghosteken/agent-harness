...
- **Skill scope:** `quality-assurance`, `test-driven-development`, `browser-testing-with-devtools`, `debugging-and-error-recovery`, `source-driven-development`, `code-review-and-quality`, `spec-driven-development`, `incremental-implementation`, `git-workflow-and-versioning`, `observability-and-instrumentation`
