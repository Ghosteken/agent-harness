...
- **Skill scope:** `performance-optimization`, `browser-testing-with-devtools`, `frontend-ui-engineering`, `debugging-and-error-recovery`, `source-driven-development`, `web-performance-optimization`, `performance-profiling`, `pagespeed-enhancer`, `react-component-performance`, `code-simplification`, `observability-and-instrumentation`, `progressive-web-app`, `application-performance-performance-optimization`, `nextjs-best-practices`, `k6-load-testing`, `performance-testing-review-ai-review`, `grafana-dashboards`, `slo-implementation`, `tailwind-patterns`, `incremental-implementation`.
