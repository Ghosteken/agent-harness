...
| [project-scaffolding](skills/project-scaffolding/SKILL.md) | Scaffolds a new project's folder structure, tooling, and config based on its tech stack and project type — asks before generating anything | Starting a new project (or a new package in a monorepo) with nothing meaningful built yet |
